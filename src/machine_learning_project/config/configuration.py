...
from machine_learning_project.utils.common import read_yaml, create_directories, save_json
...
class ConfigurationManager:
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(
            ...
            target_column = schema.name,
            mlflow_uri="https://dagshub.com/ny-essien/end-to-end-mlops-data-science-project.mlflow",
